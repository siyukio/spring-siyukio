...
public class OpenApiController {
    ...
    public JSONObject createOpenApi(String host, SortedMap<String, ApiDefinition> sortedMap) {
        //OpenApi
    ...
    private JSONObject createPathItem(ApiDefinition apiDefinition) {
        //pathItem
    ...
    private JSONArray createGlobalParameters(ApiDefinition apiDefinition) {
    ...
    private JSONObject createRequestBody(ApiDefinition apiDefinition) {
    ...
    public JSONObject createObjectRequest(JSONArray requestParameters) {
    ...
    private JSONObject createArrayRequest(JSONObject arrayParamJson) {
        JSONObject requestParamJson = new JSONObject();
        //type
    ...
    private JSONObject createResponses(ApiDefinition apiDefinition) {
    ...
    public JSONObject createObjectResponse(JSONArray responseParamArray) {
    ...
    private JSONObject createArrayResponse(JSONObject arrayParamJson) {
        JSONObject requestParamJson = new JSONObject();
        //type
        requestParamJson.put("type", "array");
        //description
    ...
    public JSONObject apiDocs(@RequestHeader(name = "HOST", required = false) String host) {
        ...
        return createOpenApi(host, sortedMap);
    }
