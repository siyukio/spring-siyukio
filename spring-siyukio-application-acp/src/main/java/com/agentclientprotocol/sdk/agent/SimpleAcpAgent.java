...
import static com.agentclientprotocol.sdk.agent.AcpAgent.DEFAULT_REQUEST_TIMEOUT;
...
public interface SimpleAcpAgent {
    ...
    class AsyncAgentBuilder {
         ...
         * @return This builder for chaining
         */
        public AsyncAgentBuilder initializeHandler(AcpAgent.InitializeHandler handler) {
         ...
         * @return This builder for chaining
         */
        public AsyncAgentBuilder authenticateHandler(AcpAgent.AuthenticateHandler handler) {
         ...
         * @return This builder for chaining
         */
        public AsyncAgentBuilder newSessionHandler(AcpAgent.NewSessionHandler handler) {
         ...
         * @return This builder for chaining
         */
        public AsyncAgentBuilder loadSessionHandler(AcpAgent.LoadSessionHandler handler) {
         ...
         * @return This builder for chaining
         */
        public AsyncAgentBuilder promptHandler(AcpAgent.PromptHandler handler) {
         ...
         * @return This builder for chaining
         */
        public AsyncAgentBuilder setSessionModeHandler(AcpAgent.SetSessionModeHandler handler) {
         ...
         * @return This builder for chaining
         */
        public AsyncAgentBuilder setSessionModelHandler(AcpAgent.SetSessionModelHandler handler) {
         ...
         * @return This builder for chaining
         */
        public AsyncAgentBuilder cancelHandler(AcpAgent.CancelHandler handler) {
