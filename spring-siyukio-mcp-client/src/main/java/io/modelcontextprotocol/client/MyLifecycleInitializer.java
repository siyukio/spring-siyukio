...
import io.modelcontextprotocol.spec.MyMcpClientSession;
 ...
 * </ul>
 */
class MyLifecycleInitializer {

    private static final Logger logger = LoggerFactory.getLogger(MyLifecycleInitializer.class);

    /**
     * The MCP session supplier that manages bidirectional JSON-RPC communication between
     * clients and servers.
     */
    private final Function<ContextView, MyMcpClientSession> sessionSupplier;
    ...
    public MyLifecycleInitializer(McpSchema.ClientCapabilities clientCapabilities, McpSchema.Implementation clientInfo,
                                  List<String> protocolVersions, Duration initializationTimeout,
                                  Function<ContextView, MyMcpClientSession> sessionSupplier) {
    ...
    private Mono<McpSchema.InitializeResult> doInitialize(DefaultInitialization initialization, ContextView ctx) {
        ...
        MyMcpClientSession mcpClientSession = initialization.mcpSession();
    ...
    private static class DefaultInitialization implements Initialization {
         ...
         * notifications.
         */
        private final AtomicReference<MyMcpClientSession> mcpClientSession;
        ...
        // ----------------------------------------------------
        public MyMcpClientSession mcpSession() {
        ...
        // ---------------------------------------------------
        private void setMcpClientSession(MyMcpClientSession mcpClientSession) {
